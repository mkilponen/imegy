...
render(){
    ...
    let helperText = this.state.checkBox ? 'Gallery will get deleted after initial view. No recovery.' : ''
    let _this  = this;
      ...
      return (
        ...
        <div style={{top: '15%', position: 'relative'}}>
          ...
          <Line
            ...
            strokeWidth="3"
            strokeColor="green" />
          <p style={{bottom: 110, position: 'relative'}} className="center">{this.state.wait}/{this.state.images.length}</p>
          <p style={{top: 10, position: 'relative'}} className="center">Please wait...</p>
        </div>
        </div>
      )
    }
    ...
    if(this.state.success){
      ...
      return (
        <div className="newPostContainer">
            <h1>success!</h1>
            <p className="center">http://localhost:3000/{this.state.newGalleryKey}</p>
            ...
            <div className='galleryControls'>
               ...
               <Button style={{marginLeft: 5}} onClick={() => _this.props.appState({page: 'gallery', galleryId: this.state.newGalleryKey})} variant="outlined">
          ...
          <div className="newPostContainer">
              ...
              <div className="optionsContainer">
                    ...
                    <div className='galleryControls'>
                           ...
                           <Button style={{marginLeft: 5}} onClick={this.submit} variant="outlined">
                            save gallery
