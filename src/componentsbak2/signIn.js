    ...
    firebase.database().ref('/users/').once('value').then((snapshot) => {
          ...
          snapshot.forEach((childSnap) => {
            ...
            if(_this.state.username === username){
              ...
              _this.setState({loading: false, error: '', username: '', password: ''})
            }
          })
    })
  }
      ...
      if(this.props.mobileDevice){return(
        ...
        return(
          <div className='signInDesktop'>
            ...
            <p className='navigation' onClick={() => this.props.appState({page: 'user', headerVideoPlays: true})}>my galleries</p>
            <p className='navigation'  name='about' onClick={() => this.props.appState({page: 'newGallery', headerVideoPlays: true})}>new post</p>
            <p className='navigation'  name='about' onClick={() => this.props.appState({page: 'welcome', headerVideoPlays: false})}>home</p>
          </div>
        )
      }
            ...
            <div style={{display: 'inline'}}>
              <div className='signInDesktop' name='controls'>
               ...
               <label htmlFor="contained-button-file">
                  <p className='navigation'  name='about'>new gallery</p>
                </label>
