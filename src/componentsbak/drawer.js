  ...
  const sideList = side => (
    ...
    >
      ...
      <List>
        {props.loggedIn ?
          <div>
            {[{text: 'home', page: 'welcome'}, {text: 'new post', page: 'newPost'}, {text: 'my galleries', page: 'user'}, {text: 'about', page: 'about'}  ].map((item, index) => (
          ...
          {[{text: 'home', page: 'welcome'}, {text: 'new post', page: 'newPost'}, {text: 'about', page: 'about'}  ].map((item, index) => (
          <ListItem button key={item.text} onClick={() => props.appState({page: item.page, headerVideoPlays: true})}>
            <ListItemIcon></ListItemIcon>
            <ListItemText primary={item.text} />
          </ListItem>
